...
export const metadata = {
  title: "About Us - PAIB",
  description: "Learn about Pak Artificial Intelligence & Blockchain's mission, vision, and journey in AI innovation.",
}
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Pak Artificial Intelligence & Blockchain is pioneering the future of AI in Pakistan, creating innovative
